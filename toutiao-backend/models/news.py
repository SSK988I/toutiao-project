...
from sqlalchemy import ForeignKey, Index, Integer, DateTime, String, Text
...
class Category(Base):
  ...
  sort_order: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment="排序字段，数值越小优先展示")
